...
shutter_value = 33  # Valeur initiale pour l'obturateur (canal 4), 33 pour ouvert
step = 5          # Incrément pour chaque appui

# --- Fonction d'envoi de la trame DMX ---
def send_dmx(pan, tilt, color, shutter):
    ...
    try:
        ...
        print(f"DMX transmis  =>  PAN: {pan} | TILT: {tilt} | Couleurs: {color} | Obturateur: {shutter}")
    except Exception as e:
...
try:
    ...
    send_dmx(pan_value, tilt_value, color_value, shutter_value)
